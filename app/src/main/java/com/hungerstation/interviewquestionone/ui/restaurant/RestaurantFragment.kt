package com.hungerstation.interviewquestionone.ui.restaurant
...
class RestaurantFragment : Fragment(), RestaurantClickedListeners {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        vendorsListAdapter.restaurantClickedListeners = this
    ...
    override fun onCardClicked(resturant: Resturant?) {
        val d = RestaurantFragmentDirections.actionRestaurantFragmentToRestaurantMenuFragment(
            resturant!!
        )
